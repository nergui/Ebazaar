...
public class OrderItemImpl implements OrderItem {
    ...
    public OrderItemImpl(Integer lineitemid, Integer productid, Integer orderid, String quantity, String totalPrice){
    ...
    public OrderItemImpl(Integer productid, Integer orderid, String quantity, String totalPrice){
